      ...
      integer,parameter:: npop = 19, npart = 6400
      integer,parameter:: iflowseed = 54321
      integer,parameter:: NTAB = 32 
      integer,parameter:: ndiag = 500, nstat = 10, nspec=100
      integer,parameter:: nflowout = 500, npartout = 500   
      integer,parameter:: nmovieout = 20000000, nsij = 1000     
      integer,parameter:: irelease = 1
      integer,parameter:: iprocrate = 2  

      real,parameter:: rho0 = 1.0, rhopart = 5.0
      real,parameter:: rad = 4.0, mingap = 2.0
