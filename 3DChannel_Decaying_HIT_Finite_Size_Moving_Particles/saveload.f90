...
!===========================================================================
! this is to monitor the mean and maximum flow velocity and particle velocity
      subroutine diag 
      use mpi
      use var_inc
      implicit none
...
!      integer, dimension(2):: idwp, idomgp  
      ...
      real umeant,vmeant,wmeant,volf
...
!     end if
      ...
      if(myid == 0)then
       ...
       write(26,260) ttt, vmax, imout,jmout,kmout, umeant,vmeant,wmeant,                 &
                           urmst,vrmst,wrmst,volf,rhomax,rhomin
       write(*,*)'ttt,vmax,imout,jmout,kmout,umean,vmean,wmean,umeans,vmeans,wmeans=', &
         ttt,vmax,imout,jmout,kmout,umeant,vmeant,wmeant,urmst,vrmst,wrmst,    &
                volf,rhomax,rhomin
        close(26)

      end if

260   format(2x, 2(1pe16.6),3I6,8(1pe16.6) ) 
