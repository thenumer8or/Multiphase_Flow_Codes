      ...
      integer,parameter:: nx7=200, nx8=250,nx = nx8-1, ny = 2*nx7, nz = nx7

      integer,parameter:: lx = nx
      integer,parameter:: lxh = lx/2, lyh = ny/2
      integer,parameter:: nxh = nx8/2, nyh = ny/2, nzh = nz/2
      integer,parameter:: npop = 19
      integer,parameter:: iflowseed = 54321
      integer,parameter:: NTAB = 32 
      integer,parameter:: ndiag = 100, nstat = 2000  , nspec=2000
      integer,parameter:: nflowout = 2000, npartout = 1000
...
!     integer,parameter:: nflowout = 10000, npartout = 10
      ...
      integer,parameter:: npart = 2160 
      real,parameter:: rad = 5.0, mingap = 2.0, mingap_w =2.0
      integer,parameter:: irelease = 1760100
...
! real*4, double complex is equivalent to complex*16. 
      ...
      character(len=80):: dircntdflow,dircntdflow0,dircntdpart
